// New Shop page using the new API instead of Supabase
...
import ProductGridApi from "@/components/shop/ProductGridApi";
import ShopPagination from "@/components/shop/ShopPagination";
import useShopFilters from "@/hooks/useShopFilters";
import useShopProductsApi from "@/hooks/useShopProductsApi"; // Using new API hook
...
const ShopApi = () => {
  ...
  const { 
    ...
    fetchAllCategories,
    fetchProducts,
  } = useShopProductsApi(); // Using new API hook
  ...
  }, [allCategories, setAvailableCategories]);
  ...
  const handleOpenAddToCartDialog = (product) => {
    setSelectedProductForDialog(product);
    setIsSizeDialogOpen(true);
  };

  const handleSizeSelectedForCart = async (size) => {
