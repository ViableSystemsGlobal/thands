...
const FloatingRegionSelector = () => {
  ...
  return (
    <div
      className={`fixed right-0 top-1/2 -translate-y-1/2 z-40 flex flex-col gap-2 transition-all duration-200 ${
        isChatOpen ? 'opacity-0 pointer-events-none translate-x-full' : 'opacity-100'
      }`}
    >
